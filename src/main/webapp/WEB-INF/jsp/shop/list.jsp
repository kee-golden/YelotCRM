...
<html lang="zh-cn">
	<head>
		...
		<c:set var="CHILD_MENU_CODE" value="Shop_List"/>
		...
		<style>
			...
			#J_shopList tr td{ position: relative; white-space: nowrap}
			#J_shopList tr td .span1{ padding:0 15px; font-size: 12px; line-height: 18px; position: absolute; left: 50%; background: #FFFFFF;
			padding: 5px;z-index: 999; border-radius: 5px; border: 1px solid #e5e5e5; display: none}
			#J_shopList{ width: 100%!important;}
			#J_shopList tr th{ white-space: nowrap}
		</style>
	...
	<%--<div id="wrapper">--%>
						...
						<div id="content" class="ibox-content">
							<div class="co_all">
								<div style="float: left">
									<a class="collapse-link" id="J_shopAdd"> <i class="fa fa-plus"></i>添加</a>
								</div>
								<form id="searchFrom"style="margin-top: -20px">
									<div id="search_Big">
										<ul class="pull-left" id="otherTab">
											<li><span >搜索：</span>
												<input type="text" id="keywords" class="inpt_width" placeholder="输入门店名称">
												<div class="clearfix"></div>
											</li>
										</ul>
										<div class="pull-right search_right"><a id="J_shopSerch" class="searfor"> <i class="glyphicon glyphicon-search sear_icon sear_icon"></i></a></div>
										<div class="clearfix" ></div>
							...
							<table id="J_shopList" class="table table-striped table-bordered table-hover">
								<thead>
									<tr>
										<th>门店名称</th>
										<th>门店地址</th>
		...
		<script src="${ctx}/module-js/shop/shop.js"></script>
	</body>
</html>