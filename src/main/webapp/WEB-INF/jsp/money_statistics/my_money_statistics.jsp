...
<head>
    ...
    <c:set var="CHILD_MENU_CODE" value="MyMoneyStatistics"/>
    <script>
        var ctx = '${ctx}';
    </script>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="wrapper wrapper-content cover_banner "
        ...
        <div class="container top_con" style=" width: 100%;min-width: 1200px">
            <h6><span class="glyphicon glyphicon-folder-open work"></span>个人业绩统计<i class="pull-right iconfont ">&#xe658;</i><div class="clearfix"></div></h6>
...
<script src="${ctx}/module-js/money_statistics/my_money_statistics.js"></script>
</html>
