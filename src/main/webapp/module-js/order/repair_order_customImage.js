        ...
        $("#attributes").empty();//清空
            ...
            for(var i=0;i<attributesJson.length;i++){
                ...
                if(attributesJson[i].type == 1){
                    var selectStr = '<td align="left" style="width: 15%"><select name=\"'+attributesJson[i].attributeName+'\" id=\"'+prifixAttribute+attributesJson[i].id+'\" disabled="disabled">';
                    var optionStr = '';
                    ...
                    var selectStr2 = '<td align="left">' +
                        '<input type=\"text\" name = \"'+attributesJson[i].attributeName+'\" id=\"'+prifixAttribute+attributesJson[i].id+'\" value=\"'+attributesJson[i].realValue+'\" readonly="readonly"/></td>\"';
