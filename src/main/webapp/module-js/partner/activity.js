...
require(['jquery', 'yaya','webuploader', 'datatables.net'], function ($, yaya,WebUploader) {
    ...
    $("input[type='checkbox']").click(function () {
        ...
        $('input[name="typeCheck"]:checked').each(function(){
            activityType.push($(this).val());
        });
        $('input[name="statusCheck"]:checked').each(function(){
            activityStatus.push($(this).val());
        });
        table.draw();
    })
    ...
    $("#searfor").click(function () {
        ...
        activityStatus=[];
        activityName = "";
        activityName = $.trim($("#keywords").val());
        $('input[name="typeCheck"]:checked').each(function(){
            activityType.push($(this).val());
        });
        $('input[name="statusCheck"]:checked').each(function(){
    ...
    var $JActivityList = $('#activityList');

     table = $JActivityList.DataTable({
        "scrollX": true,
        'processing': true,
        'searching': false,
        'lengthChange': false,
        ...
        'ajax': {
            'url': ctx + '/activity/activity-list',
            'traditional':true,
            'async':false,
            'data': function (d) {
                d.activityType=activityType;
                d.activityStatus=activityStatus;
                        ...
                        if ($.trim($('#activityName').val()) == "") {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    customerId: $('.relationCustomerId').attr('id'),
                                    customerName: $('.relationCustomerId').text(),
